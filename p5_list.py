...
monthnum = int(input("Enter the desired month number: ")) # Ask input for month number eg January == 1

if (monthnum >= 1) and (monthnum <=12): # This checks if it is a valid month number
